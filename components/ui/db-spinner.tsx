...
export default function DashboardSpinner() {
  return (
    <div className="min-h-screen bg-gray-100 flex ">
      {/* Sidebar skeleton */}
      <div className="w-[var(--small-col)] bg-[hsl(221.2,83.2%,53.3%)] animate-pulse">
        <div className="p-4">
          <div className="h-8 bg-white/20 rounded aspect-square"></div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white shadow-sm p-4 flex justify-between items-center">
          <div className="w-[45%] h-8 bg-gray-200 rounded animate-pulse"></div>
        ...
        <main className="flex-1 p-6">
          <div className="max-w-6xl mx-auto gap-y-6">
